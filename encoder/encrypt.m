...
function encrypt_QR4()
    ...
    %top left
    %Inoise(1:9*10*ratio, 1:9*10*ratio) = I(1:9*10*ratio, 1:9*10*ratio);
    %top right
    %Inoise(1:9*10*ratio, 81*10*ratio:90*10*ratio) = I(1:9*10*ratio, 81*10*ratio:90*10*ratio);
    %left bottom
    %Inoise(51*10*ratio:60*10*ratio, 1:9*10*ratio) = I(51*10*ratio:60*10*ratio, 1:9*10*ratio);
    %right bottom
    %Inoise(51*10*ratio:60*10*ratio, 81*10*ratio:90*10*ratio) = I(51*10*ratio:60*10*ratio, 81*10*ratio:90*10*ratio);
